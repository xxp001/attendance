           ...
           for(int c = 0; c <this.totalCells; c++){    
               ...
               if (null != cell){
                   if(c==0){//第一列不读
                	   ...
                	   map.put("userName", cell.getStringCellValue());//员工姓名
                   }else if(c==2){
                	   map.put("attendDate",cell.getStringCellValue().substring(0, cell.getStringCellValue().indexOf(" ")));//打卡日期
                	   map.put("attendTime", cell.getStringCellValue().substring(cell.getStringCellValue().indexOf(" ")));//打卡时间
                   }else if(c==3){
                   }else if(c==4){
                   }
                 }
